...
const NAV: Seccao[] = [
  ...
  },
  {
    ...
    itens: [
      ...
      { href: '/alugueres/situacao', label: 'Lasers em aluguer', icon: '🔆' },
      { href: '/alugueres/despesas', label: 'Despesas de Alugueres', icon: '🧾' },
      { href: '/alugueres/agenda/motorista', label: 'Vista do motorista', icon: '📱' },
...
const TITULOS: { prefixo: string; titulo: string }[] = [
  ...
  { prefixo: '/alugueres/despesas', titulo: 'Despesas de Alugueres' },
  { prefixo: '/alugueres/situacao', titulo: 'Lasers em Aluguer' },
  { prefixo: '/alugueres/agenda/motorista', titulo: 'Vista do Motorista' },
  { prefixo: '/alugueres/agenda', titulo: 'Agenda de Transportes' },
