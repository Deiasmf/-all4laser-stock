...
// Muda o estado; ao conferir regista a data de receção.
...
// Apaga uma receção (os itens caem em cascata) e a respetiva linha no livro de Encomendas.
...
// Procura em envios (EP) e reparações (RPC) para ligar a receção ao documento.
